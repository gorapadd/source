...
pluralCaseList.push( {plural: "requests", pascal: "Request"} )

pluralCaseList.push( {plural: "notifications", pascal: "Notification"} )

pluralCaseList.push( {plural: "acctInfos", pascal: "AcctInfo"} )

pluralCaseList.push( {plural: "transfers", pascal: "Transfer"} )
